...
| [deploy](/redx94/Dynamic-Neural-Network-Refinement/tree/main/deploy "deploy") | [deploy](/redx94/Dynamic-Neural-Network-Refinement/tree/main/deploy "deploy") |  |  |
| [docs](/redx94/Dynamic-Neural-Network-Refinement/tree/main/docs "docs") | [docs](/redx94/Dynamic-Neural-Network-Refinement/tree/main/docs "docs") |  |  |
| [notebooks](/redx94/Dynamic-Neural-Network-Refinement/tree/main/notebooks "notebooks") | [notebooks](/redx94/Dynamic-Neural-Network-Refinement/tree/main/notebooks "notebooks") |  |  |
| [prometheus](/redx94/Dynamic-Neural-Network-Refinement/tree/main/prometheus "prometheus") | [prometheus](/redx94/Dynamic-Neural-Network-Refinement/tree/main/prometheus "prometheus") |  |  |
| [scripts](/redx94/Dynamic-Neural-Network-Refinement/tree/main/scripts "scripts") | [scripts](/redx94/Dynamic-Neural-Network-Refinement/tree/main/scripts "scripts") |  |  |
| [src](/redx94/Dynamic-Neural-Network-Refinement/tree/main/src "src") | [src](/redx94/Dynamic-Neural-Network-Refinement/tree/main/src "src") |  |  |
| [tests](/redx94/Dynamic-Neural-Network-Refinement/tree/main/tests "tests") | [tests](/redx94/Dynamic-Neural-Network-Refinement/tree/main/tests "tests") |  |  |
| [utils](/redx94/Dynamic-Neural-Network-Refinement/tree/main/utils "utils") | [utils](/redx94/Dynamic-Neural-Network-Refinement/tree/main/utils "utils") |  |  |
| [visualization](/redx94/Dynamic-Neural-Network-Refinement/tree/main/visualization "visualization") | [visualization](/redx94/Dynamic-Neural-Network-Refinement/tree/main/visualization "visualization") |  |  |
| [.dockerignore](/redx94/Dynamic-Neural-Network-Refinement/blob/main/.dockerignore ".dockerignore") | [.dockerignore](/redx94/Dynamic-Neural-Network-Refinement/blob/main/.dockerignore ".dockerignore") |  |  |
| [.gitignore](/redx94/Dynamic-Neural-Network-Refinement/blob/main/.gitignore ".gitignore") | [.gitignore](/redx94/Dynamic-Neural-Network-Refinement/blob/main/.gitignore ".gitignore") |  |  |
| [.pre-commit-config.yaml](/redx94/Dynamic-Neural-Network-Refinement/blob/main/.pre-commit-config.yaml ".pre-commit-config.yaml") | [.pre-commit-config.yaml](/redx94/Dynamic-Neural-Network-Refinement/blob/main/.pre-commit-config.yaml ".pre-commit-config.yaml") |  |  |
| [CHANGELOG.md](/redx94/Dynamic-Neural-Network-Refinement/blob/main/CHANGELOG.md "CHANGELOG.md") | [CHANGELOG.md](/redx94/Dynamic-Neural-Network-Refinement/blob/main/CHANGELOG.md "CHANGELOG.md") |  |  |
| [Dockerfile](/redx94/Dynamic-Neural-Network-Refinement/blob/main/Dockerfile "Dockerfile") | [Dockerfile](/redx94/Dynamic-Neural-Network-Refinement/blob/main/Dockerfile "Dockerfile") |  |  |
| [LICENSE](/redx94/Dynamic-Neural-Network-Refinement/blob/main/LICENSE "LICENSE") | [LICENSE](/redx94/Dynamic-Neural-Network-Refinement/blob/main/LICENSE "LICENSE") |  |  |
| [Makefile](/redx94/Dynamic-Neural-Network-Refinement/blob/main/Makefile "Makefile") | [Makefile](/redx94/Dynamic-Neural-Network-Refinement/blob/main/Makefile "Makefile") |  |  |
| [README.md](/redx94/Dynamic-Neural-Network-Refinement/blob/main/README.md "README.md") | [README.md](/redx94/Dynamic-Neural-Network-Refinement/blob/main/README.md "README.md") |  |  |
| [docker-compose.yml](/redx94/Dynamic-Neural-Network-Refinement/blob/main/docker-compose.yml "docker-compose.yml") | [docker-compose.yml](/redx94/Dynamic-Neural-Network-Refinement/blob/main/docker-compose.yml "docker-compose.yml") |  |  |
| [environment.yml](/redx94/Dynamic-Neural-Network-Refinement/blob/main/environment.yml "environment.yml") | [environment.yml](/redx94/Dynamic-Neural-Network-Refinement/blob/main/environment.yml "environment.yml") |  |  |
| [mkdocs.yml](/redx94/Dynamic-Neural-Network-Refinement/blob/main/mkdocs.yml "mkdocs.yml") | [mkdocs.yml](/redx94/Dynamic-Neural-Network-Refinement/blob/main/mkdocs.yml "mkdocs.yml") |  |  |
| [pyproject.toml](/redx94/Dynamic-Neural-Network-Refinement/blob/main/pyproject.toml "pyproject.toml") | [pyproject.toml](/redx94/Dynamic-Neural-Network-Refinement/blob/main/pyproject.toml "pyproject.toml") |  |  |
| [requirements.txt](/redx94/Dynamic-Neural-Network-Refinement/blob/main/requirements.txt "requirements.txt") | [requirements.txt](/redx94/Dynamic-Neural-Network-Refinement/blob/main/requirements.txt "requirements.txt") |  |  |
| [setup.cfg](/redx94/Dynamic-Neural-Network-Refinement/blob/main/setup.cfg "setup.cfg") | [setup.cfg](/redx94/Dynamic-Neural-Network-Refinement/blob/main/setup.cfg "setup.cfg") |  |  |
| [setup.py](/redx94/Dynamic-Neural-Network-Refinement/blob/main/setup.py "setup.py") | [setup.py](/redx94/Dynamic-Neural-Network-Refinement/blob/main/setup.py "setup.py") |  |  |
| View all files |
...
[Permalink: Running Tests](#running-tests)
...
This project is licensed under the [GNU Affero General Public License v3.0 (AGPLv3)](/redx94/Dynamic-Neural-Network-Refinement/blob/main/LICENSE).
...
[Activity](/redx94/Dynamic-Neural-Network-Refinement/activity)
